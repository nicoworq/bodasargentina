<?php
/*
  Template Name: Template Beneficios premium
 */

get_header();
?>

<section id="beneficios-premium">
    ...
    <div class="beneficios-premium-contenido container">
        <div class='col-md-12'>
            <?php
            $pagina = get_page_by_title('Beneficios Videografos');
