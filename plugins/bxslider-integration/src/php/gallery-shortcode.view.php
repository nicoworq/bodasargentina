    ...
    <div class="gallery-wrapper" id="gallery-worq">
        <div class="bxslider">
            ...
            foreach ($attachments as $attachment) :
                ...
                $url_link = get_post_meta( $attachment->ID, '_gallery_link_url', true );
                ...
                <div class="bxslide">
                    ...
                    ?>
                    <div class="autor-foto">Fotografía de <a href="<?php echo $url_link; ?>"><?php echo $attachment->post_excerpt; ?></a></div>
                </div>
            <?php endforeach; ?>
        </div>
    </div>
        ...
        <div class="pager-wrapper">
            <div class="bxpager">
                ...
                foreach ($attachments as $attachment) :
                    ...
                    echo sprintf('<a data-slide-index="%4$s" href="" title="%3$s"><img src="%1$s" alt="%2$s" title="%3$s" /></a>', $img_attr[0], esc_attr($desc), esc_attr($title), $i);
                    ++$i;
                endforeach;
                ?>
            </div>
